        ...
        <div className={styles.pageWrapper}>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.cardGrid}>
                    ...
                    <div className={styles.card}>
                        <img src="/images/service5.jpg" alt="service5" />
                    </div>

                    <div className={styles.card}>
                        <img src="/images/service6.jpg" alt="service6" />
                    </div>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.serviceListGrid}>
                    ...
                    <div className={styles.serviceListItem}>
                        ...
                        <div className={styles.serviceDesc}>คำขอเก็บหน่วยกิตการศึกษาต่อเนื่องเพิ่มเติม (โอนย้าย หน่วยกิต ในรอบการศึกษา 5 ปี)</div>
                    </div>
                </div>
            </section>
        </div>
